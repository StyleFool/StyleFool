...
parser.add_argument('--color', action='store_false', help='need to calculate the theme colors')
...
parser.add_argument('--prepare-save-path',  type=str, default='./styles_main_color_csv/', help='path to save theme colors and target class confidence')
...
def main():
    ...
    if args.color:
        print('calculating theme colors ...')
